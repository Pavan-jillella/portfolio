...
export function MonthlySummaryCards({ income, expenses }: MonthlySummaryCardsProps) {
  ...
  const cards = [
    ...
    { label: "Net Profit", value: `${savings >= 0 ? "+" : ""}${formatCurrency(savings)}`, color: savings >= 0 ? "text-emerald-400" : "text-red-400" },
