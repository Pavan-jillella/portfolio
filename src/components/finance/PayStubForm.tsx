...
export function PayStubForm({ open, onClose, onSubmit, editStub, defaultEmployer, employers, taxConfig }: PayStubFormProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="glass-card rounded-3xl p-8 w-full max-w-lg relative my-8 flex flex-col max-h-[calc(100vh-4rem)]">
        <button onClick={onClose} className="absolute top-6 right-6 text-white/30 hover:text-white transition-colors z-10">
        ...
        <h3 className="font-display font-semibold text-lg text-white mb-6 shrink-0">
