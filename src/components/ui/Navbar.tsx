                ...
                {userMenuOpen && (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 w-full px-2 py-2 rounded-lg hover:bg-white/5 transition-colors text-white/60 hover:text-white"
                    >
        ...
        {menuOpen && (
          ...
          >
            <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col gap-4">
              ...
              {/* Mobile sign out — only when authenticated */}
              {user && (
                <div className="pt-3 mt-1 border-t border-white/5">
                  <button
                    onClick={handleSignOut}
